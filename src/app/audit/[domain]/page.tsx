    ...
    <div className="pt-16 pb-16">
      ...
      <div className="surface-card-inset p-8 md:p-12 relative overflow-hidden">
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <a href="https://cal.com/ghulam-mustafa-ecxxcu/15min" target="_blank" rel="noreferrer" className="accent-button inline-flex items-center justify-center gap-2 px-8 py-4 transition-all text-lg">
